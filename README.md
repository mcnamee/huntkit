...
| [linkfinder](https://github.com/GerbenJavado/LinkFinder) | _Discover endpoints and their parameters in JavaScript files._ <br> `( cd $TOOLS/linkfinder && python3 linkfinder -i https://example.com -d -o cli )` |
